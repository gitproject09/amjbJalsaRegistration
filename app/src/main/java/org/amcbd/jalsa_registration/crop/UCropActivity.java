package org.amcbd.jalsa_registration.crop;
...
import org.amcbd.jalsa_registration.activity.BaseActivity;
...
public class UCropActivity extends BaseActivity {
    ...
    private void setupViews(@NonNull Intent intent) {
        ...
        mActiveWidgetColor = intent.getIntExtra(UCrop.Options.EXTRA_UCROP_COLOR_WIDGET_ACTIVE, ContextCompat.getColor(this, com.yalantis.ucrop.R.color.ucrop_color_widget_background));
